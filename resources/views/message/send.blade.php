    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title set-font" style="margin-bottom: 15px">ارسال پیام</h4>
                        @if(session('success'))
                    ...
                    <div class="content">
                        <form method="post" action="{{route('message-send-post')}}">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{$errors->has('title') ? 'has-error' : ''}}">
                                        ...
                                        <input required type="text" class="form-control"
                                               placeholder="عنوان پیام" name="title">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{$errors->has('title') ? 'has-error' : ''}}">
                                        <label for="receiver">دریافت کننده (ها)</label>
