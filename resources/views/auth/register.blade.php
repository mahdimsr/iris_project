            ...
            <div class="card register-form">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('تائیدیه رمز') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="postId" class="col-md-4 col-form-label text-md-right">{{ __('سمت') }}</label>

                            <div class="col-md-6">
                                <select name="postId" id="postId" style="width: 100%;">
                                    <option value="1">مدیر</option>
                                    <option value="2">دبیر جلسه</option>
                                    <option value="3">منشی</option>
                                    <option value="4">کارمند</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="genre" class="col-md-4 col-form-label text-md-right">{{ __('جنسیت') }}</label>
